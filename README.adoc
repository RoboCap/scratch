image:slideshow/images/Scratch_Logo.svg.png[width=40%]
...
Pleaso refer link:organization/workstation-preparation.adoc[this document] for detailed instructions how to prepare the workstations.
